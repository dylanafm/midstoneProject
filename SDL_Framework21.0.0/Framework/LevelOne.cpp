...
LevelOne::LevelOne(SDL_Window* sdlWindow_) {
	...
	fish[2] = new Fish(SDL_Rect{ 1200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[3] = new Fish(SDL_Rect{ 1600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[4] = new Fish(SDL_Rect{ 1600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[5] = new Fish(SDL_Rect{ 1800, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[6] = new Fish(SDL_Rect{ 1800, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[7] = new Fish(SDL_Rect{ 2000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[8] = new Fish(SDL_Rect{ 2000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[9] = new Fish(SDL_Rect{ 3000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[10] = new Fish(SDL_Rect{ 3000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[11] = new Fish(SDL_Rect{ 3100, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[12] = new Fish(SDL_Rect{ 3100, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[13] = new Fish(SDL_Rect{ 3200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[14] = new Fish(SDL_Rect{ 3200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[15] = new Fish(SDL_Rect{ 3200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[16] = new Fish(SDL_Rect{ 3300, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[17] = new Fish(SDL_Rect{ 3300, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[18] = new Fish(SDL_Rect{ 3400, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[19] = new Fish(SDL_Rect{ 3400, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[20] = new Fish(SDL_Rect{ 3500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[21] = new Fish(SDL_Rect{ 3500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[22] = new Fish(SDL_Rect{ 3500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[23] = new Fish(SDL_Rect{ 3500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[24] = new Fish(SDL_Rect{ 3600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[25] = new Fish(SDL_Rect{ 3600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[26] = new Fish(SDL_Rect{ 3700, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[27] = new Fish(SDL_Rect{ 3800, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[28] = new Fish(SDL_Rect{ 3900, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[29] = new Fish(SDL_Rect{ 4000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[30] = new Fish(SDL_Rect{ 4000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[31] = new Fish(SDL_Rect{ 4000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[32] = new Fish(SDL_Rect{ 4000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[33] = new Fish(SDL_Rect{ 5000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[34] = new Fish(SDL_Rect{ 5000, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[35] = new Fish(SDL_Rect{ 5100, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[36] = new Fish(SDL_Rect{ 5100, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[37] = new Fish(SDL_Rect{ 5200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[38] = new Fish(SDL_Rect{ 5200, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[39] = new Fish(SDL_Rect{ 5300, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[40] = new Fish(SDL_Rect{ 5300, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[41] = new Fish(SDL_Rect{ 5300, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[42] = new Fish(SDL_Rect{ 5400, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[43] = new Fish(SDL_Rect{ 5500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[44] = new Fish(SDL_Rect{ 5600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[45] = new Fish(SDL_Rect{ 6400, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[46] = new Fish(SDL_Rect{ 6500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[47] = new Fish(SDL_Rect{ 6500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[48] = new Fish(SDL_Rect{ 6500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[49] = new Fish(SDL_Rect{ 6500, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[50] = new Fish(SDL_Rect{ 6600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[51] = new Fish(SDL_Rect{ 6600, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[52] = new Fish(SDL_Rect{ 6700, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[53] = new Fish(SDL_Rect{ 6700, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[54] = new Fish(SDL_Rect{ 6800, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[55] = new Fish(SDL_Rect{ 6800, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[56] = new Fish(SDL_Rect{ 6900, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
	fish[57] = new Fish(SDL_Rect{ 6900, rand() % 680, 50, 50 }, 2, renderer, "textures/blobfish.png", 25.0f, 8);
